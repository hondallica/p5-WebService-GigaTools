...
The module provides a simple interface to the GigaTools API. To use this module, you must first sign up at L<http://api.gagatools.com> to receive an API key.
